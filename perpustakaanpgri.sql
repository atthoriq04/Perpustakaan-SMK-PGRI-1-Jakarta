...
-- Records of anggota
-- ----------------------------
INSERT INTO `anggota` VALUES (99281, 'Dera', 10, 'masterblad213@gmail.com', 'Jakarta', '0821295332112', 'Sukabumi, 12 Oktober 1999', '2023-04-19');
INSERT INTO `anggota` VALUES (99282, 'Radika', 10, 'radika@gmail.com', 'Jakarta', '0821223221', 'Jakarta, 20 April 2022', '2023-04-20');
INSERT INTO `anggota` VALUES (99283, 'Yos', 10, 'yos@gmail.com', 'Jakarta', '08212231122', 'Jakarta, 20 April 2022', '2022-04-21');
INSERT INTO `anggota` VALUES (99321, 'Dera', 4, 'Alamat@email.Siswa', 'Bekasi	', '000088889999', 'Sukabumi, 12 Oktober 1999', '2023-05-16');
INSERT INTO `anggota` VALUES (99801, 'Budiman ', 6, 'Alamat@email.Siswa', 'Alamat', '000088889999', 'Jakarta, 25 Mei 2004', '2023-05-15');
INSERT INTO `anggota` VALUES (99802, 'Juan', 6, 'Alamat@email.Siswa', 'Alamat', '000088889999', 'Jakarta, 22 Januari 2005', '2023-05-15');
INSERT INTO `anggota` VALUES (99816, 'Muhlisan', 5, 'Alamat@email.Siswa', 'Jl.Muhlis', '000088889999', 'Jakarta, 10 juli 2004', '2023-05-13');
INSERT INTO `anggota` VALUES (99817, 'Muhlisin', 5, 'Alamat@email.Siswa', 'Jl.Muhlis', '000088889999', 'Jakarta, 10 juli 2004', '2023-05-13');
INSERT INTO `anggota` VALUES (99818, 'Hidayatunjan', 5, 'Alamat@email.Siswa', 'Jl.HjHjaHj', '000088889999', 'Jakarta, 10 mei 2004', '2023-05-13');
...
CREATE TABLE `biblio`  (
  ...
  `carrier_type_id` int NULL DEFAULT NULL,
...
-- ----------------------------
-- Table structure for bukutidaktersedia
-- ----------------------------
DROP TABLE IF EXISTS `bukutidaktersedia`;
CREATE TABLE `bukutidaktersedia`  (
  `IdRusak` int NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of bukutidaktersedia
-- ----------------------------
INSERT INTO `bukutidaktersedia` VALUES (1, '777123451', 1, '2022-05-14');
INSERT INTO `bukutidaktersedia` VALUES (3, '7721318191', 4, '2022-05-14');
INSERT INTO `bukutidaktersedia` VALUES (4, 'B00018', 5, '2022-05-15');
...
CREATE TABLE `denda`  (
  ...
  `Barang` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
-- Records of denda
-- ----------------------------
INSERT INTO `denda` VALUES (1, 2, 'NonTunai', 'Vas Bunga', 0, '3', 'Menghilangkan Buku');
INSERT INTO `denda` VALUES (2, 5, 'Tunai', '-', 3500, '1', 'Keterlambatan Pengembalian');
INSERT INTO `denda` VALUES (3, 4, 'Tunai', '-', 3500, '3', 'Keterlambatan Pengembalian');
INSERT INTO `denda` VALUES (4, 6, 'Tunai', '-', 50000, '3', 'Menghilangkan Buku');
INSERT INTO `denda` VALUES (5, 9, 'NonTunai', 'Vas Bunga', 0, '3', 'Menghilangkan Buku');
...
INSERT INTO `gmd` VALUES (34, NULL, 'null', NULL, '2022-05-18', '2022-05-18');
...
-- Records of item
-- ----------------------------
INSERT INTO `item` VALUES (1, 1, '400-300', NULL, 'C0031', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, '2022-05-18 13:02:44', '2022-05-18 13:02:44', NULL);
INSERT INTO `item` VALUES (2, 2, '400-301', NULL, 'C0035', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, '2022-05-18 13:02:44', '2022-05-18 13:02:44', NULL);
...
CREATE TABLE `judulnotifikasi`  (
  `IdJudul` int NOT NULL AUTO_INCREMENT,
  `JudulNotifikasi` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `Warna` varchar(15) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`IdJudul`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of judulnotifikasi
-- ----------------------------
INSERT INTO `judulnotifikasi` VALUES (1, 'Pengembalian Gagal !!', '(217, 83, 79)');
INSERT INTO `judulnotifikasi` VALUES (2, 'Pengembalian berhasil !!', '(2, 117, 216)');
INSERT INTO `judulnotifikasi` VALUES (3, 'Pembayaran Denda Berhasil !!', '(2, 117, 216)');
INSERT INTO `judulnotifikasi` VALUES (4, 'Anda Mendapat Denda !!', '(217, 83, 79)');
INSERT INTO `judulnotifikasi` VALUES (5, 'Surat Bebas Pustaka Sudah Dicetak !!', '(2, 117, 216)');
INSERT INTO `judulnotifikasi` VALUES (6, 'Permintaan Surat bebas Pustaka Anda Ditolak !!', '(217, 83, 79)');
...
-- Records of jurusan
-- ----------------------------
INSERT INTO `jurusan` VALUES ('AKL', 'Akuntansi dan Keuangan Lembaga');
INSERT INTO `jurusan` VALUES ('BDP', 'Bisnis Daring dan Pemasaran');
INSERT INTO `jurusan` VALUES ('MM', 'Multimedia');
INSERT INTO `jurusan` VALUES ('OTP', 'Otomatisasi dan Tata kelola Perkantoran');
...
INSERT INTO `kelas` VALUES (30, 'XI', 'BDP', '1');
INSERT INTO `kelas` VALUES (32, 'XII', 'BDP', '1');
INSERT INTO `kelas` VALUES (33, 'X', 'BDP', '1');
...
INSERT INTO `mst_author` VALUES (31, 'Diyah', NULL, NULL);
INSERT INTO `mst_author` VALUES (33, 'null', '2022-05-18', '2022-05-18');
...
INSERT INTO `mst_language` VALUES (10, 'null', '2022-05-18', '2022-05-18');
...
-- ----------------------------
INSERT INTO `mst_location` VALUES (3, 'Dipinjam', '2022-05-13', '2022-05-13');
INSERT INTO `mst_location` VALUES (2, 'Perpustakaan PGRI', '2022-05-02', '2022-05-02');
INSERT INTO `mst_location` VALUES (4, 'Tidak Tersedia/Rusak/Hilang', '2022-05-14', '2022-05-14');
INSERT INTO `mst_location` VALUES (6, 'Pojok Baca ', NULL, NULL);
...
INSERT INTO `mst_place` VALUES (34, 'null', '2022-05-18', '2022-05-18');
...
INSERT INTO `mst_publisher` VALUES (50, 'null', '2022-05-18', '2022-05-18');
...
CREATE TABLE `new_bliblio`  (
  `IdBliblio` int NOT NULL AUTO_INCREMENT,
  `IdGMD` int NULL DEFAULT NULL,
  `Judul` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `author_id` int NULL DEFAULT NULL,
  `subjek` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  ...
  `TempatTerbit` int NULL DEFAULT NULL,
  `Klasifikasi` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `abstrak` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `image` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `penanggung` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `input_date` datetime NULL DEFAULT NULL,
  `last_update` datetime NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `new_bliblio` VALUES (1, 1, 'How To be Pro', 1, '', 'E.5', '33125523', 1, '2011', 'Good', 'Series 1', '400-300', 1, 1, '502', '', 'D:CollageSmester 8ProjectPerpustakaan-SMK-PGRI-1-Jakartasrcperpustakaansmkpgripkg1jakartaButtonCover.png', '', '2022-05-18 13:02:44', '2022-05-18 13:02:44');
INSERT INTO `new_bliblio` VALUES (2, 2, 'PHP', 2, '', 'E.6', '2231142', 2, '2011', 'Very Very GOOD', 'Series 2', '400-301', 1, 1, '503', '', 'D:CollageSmester 8ProjectPerpustakaan-SMK-PGRI-1-Jakartasrcperpustakaansmkpgripkg1jakartaButtonCover.png', '', '2022-05-18 13:02:44', '2022-05-18 13:02:44');
...
CREATE TABLE `notifikasi`  (
  ...
  `Nis` int NOT NULL,
  `Isi` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `Tanggal` date NOT NULL,
...
-- ----------------------------
INSERT INTO `notifikasi` VALUES (1, 1, 99281, 'Buku Yang Dikembalikan Tidak Sesuai(Kode Transaksi = 2 )', '2022-05-14', 1);
INSERT INTO `notifikasi` VALUES (2, 4, 99281, 'Anda Mendapat Denda Merusak/Menghilangkan Buku(Kode Transaksi = 2 )', '2022-05-14', 1);
INSERT INTO `notifikasi` VALUES (3, 2, 99281, 'Pengembalian Buku Berhasil(Kode Transaksi = 3 )', '2022-05-14', 1);
INSERT INTO `notifikasi` VALUES (5, 4, 99283, 'Anda Mendapat Denda Keterlambatan Pengembalian Buku(Kode Transaksi = 5 )', '2022-05-14', 1);
INSERT INTO `notifikasi` VALUES (6, 4, 99282, 'Anda Mendapat Denda Keterlambatan Pengembalian Buku(Kode Transaksi = 4 )', '2022-05-14', 1);
INSERT INTO `notifikasi` VALUES (7, 4, 99817, 'Anda Mendapat Denda Merusak/Menghilangkan Buku(Kode Transaksi = 6 )', '2022-05-14', 1);
INSERT INTO `notifikasi` VALUES (8, 3, 99281, 'Denda Dengan Kode 1 Berhasil Dibayarkan', '2022-05-14', 1);
INSERT INTO `notifikasi` VALUES (9, 4, 99817, 'Anda Mendapat Denda Merusak/Menghilangkan Buku(Kode Transaksi = 9 )', '2022-05-15', 1);
INSERT INTO `notifikasi` VALUES (11, 3, 99817, 'Denda Dengan Kode  5 Berhasil Dibayarkan ', '2022-05-15', 1);
INSERT INTO `notifikasi` VALUES (12, 3, 99817, 'Denda Dengan Kode  4 Berhasil Dibayarkan ', '2022-05-15', 1);
INSERT INTO `notifikasi` VALUES (13, 3, 99282, 'Denda Dengan Kode  3 Berhasil Dibayarkan ', '2022-05-15', 1);
INSERT INTO `notifikasi` VALUES (14, 6, 99283, 'Silahkan Cek Kembali Status Peminjaman Dan Denda Anda', '2022-05-16', 1);
...
CREATE TABLE `pengaturan`  (
  `idPengaturan` int NOT NULL AUTO_INCREMENT,
  `LamaPinjam` int NOT NULL,
  `DendaHarian` int NOT NULL,
  PRIMARY KEY (`idPengaturan`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 501 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pengaturan
-- ----------------------------
INSERT INTO `pengaturan` VALUES (500, 1, 500);
...
INSERT INTO `pengunjung` VALUES (4, 'Radika', 'radika@gmail.com', 'Siswa', '2022-05-10 18:33:49');
INSERT INTO `pengunjung` VALUES (5, 'Dera', 'masterblad213@gmail.com', 'Siswa', '2022-05-14 14:14:12');
INSERT INTO `pengunjung` VALUES (6, 'Radika', 'radika@gmail.com', 'Siswa', '2022-05-14 21:27:44');
INSERT INTO `pengunjung` VALUES (7, 'Yos', 'yos@gmail.com', 'Siswa', '2022-05-14 21:35:07');
INSERT INTO `pengunjung` VALUES (8, 'Muhlisin', 'Alamat@email.Siswa', 'Siswa', '2022-05-14 21:37:18');
INSERT INTO `pengunjung` VALUES (9, 'Radika', 'radika@gmail.com', 'Siswa', '2022-05-15 11:16:00');
INSERT INTO `pengunjung` VALUES (10, 'Muhlisin', 'Alamat@email.Siswa', 'Siswa', '2022-05-15 14:40:29');
INSERT INTO `pengunjung` VALUES (11, 'Yos', 'yos@gmail.com', 'Siswa', '2022-05-15 17:01:52');
INSERT INTO `pengunjung` VALUES (12, 'Hidayatunjan', 'Alamat@email.Siswa', 'Siswa', '2022-05-15 17:02:31');
INSERT INTO `pengunjung` VALUES (13, 'Budiman ', 'Alamat@email.Siswa', 'Siswa', '2022-05-15 22:50:21');
INSERT INTO `pengunjung` VALUES (14, 'Ardian Syaputra', 'Ardian@gmail.com', 'Penyidik KPK', '2022-05-15 22:53:22');
INSERT INTO `pengunjung` VALUES (15, 'Radika', 'radika@gmail.com', 'Siswa', '2022-05-16 01:01:04');
INSERT INTO `pengunjung` VALUES (16, 'Yos', 'yos@gmail.com', 'Siswa', '2022-05-16 01:12:24');
INSERT INTO `pengunjung` VALUES (17, 'Muhlisin', 'Alamat@email.Siswa', 'Siswa', '2022-05-16 01:14:10');
INSERT INTO `pengunjung` VALUES (18, 'Hidayatunjan', 'Alamat@email.Siswa', 'Siswa', '2022-05-16 01:25:07');
INSERT INTO `pengunjung` VALUES (19, 'Dera', 'masterblad213@gmail.com', 'Siswa', '2022-05-16 01:50:06');
...
CREATE TABLE `petugas`  (
  ...
  `Email` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Alamat` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `NoHp` varchar(14) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
-- Records of petugas
-- ----------------------------
INSERT INTO `petugas` VALUES (123444, 'Petugas2', 'aa@aa', 'aaa', '11111');
INSERT INTO `petugas` VALUES (123455, 'Petugas', 'pet@ug.as', 'Jakarta', '089944556644');
INSERT INTO `petugas` VALUES (123456, 'Admin', 'admin@min.ad', 'Bekasi', '089644445555');
...
CREATE TABLE `transaksi`  (
  ...
  `Barcode` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Nis` int NOT NULL,
...
-- ----------------------------
INSERT INTO `transaksi` VALUES (2, '777123451', 99281, '2022-05-13', '2022-05-20', '2022-05-14', '4', 'Buku Hilang');
INSERT INTO `transaksi` VALUES (3, 'B00023', 99281, '2022-05-14', '2022-05-21', '2022-05-14', '4', 'Selesai');
INSERT INTO `transaksi` VALUES (4, '777123452', 99282, '2022-05-01', '2022-05-07', '2022-05-14', '4', 'Selesai');
INSERT INTO `transaksi` VALUES (5, 'B00018', 99283, '2022-05-14', '2022-05-21', '2022-05-14', '4', 'Selesai');
INSERT INTO `transaksi` VALUES (6, '7721318191', 99817, '2022-05-14', '2022-05-21', '2022-05-14', '4', 'Buku Hilang');
INSERT INTO `transaksi` VALUES (9, 'B00018', 99817, '2022-05-15', '2022-05-22', '2022-05-15', '4', 'Buku Hilang');
INSERT INTO `transaksi` VALUES (10, '666111222', 99283, '2022-05-15', '2022-05-15', NULL, '1', 'Dipinjam');
...
CREATE TABLE `user`  (
  `Nis` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `Username` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Password` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Role` int NOT NULL DEFAULT 3,
  PRIMARY KEY (`Nis`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 123457 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = COMPACT;

-- ----------------------------
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (99281, 'dera', 'getamped', 3);
INSERT INTO `user` VALUES (99282, 'Radz', 'radika', 3);
INSERT INTO `user` VALUES (99283, 'yos', 'yos', 3);
INSERT INTO `user` VALUES (99321, '99321', '99321', 3);
INSERT INTO `user` VALUES (99801, 'Budz', 'budiman', 3);
INSERT INTO `user` VALUES (99802, '99802', '99802', 3);
INSERT INTO `user` VALUES (99816, '99816', '99816', 3);
INSERT INTO `user` VALUES (99817, '99817', '99817', 3);
INSERT INTO `user` VALUES (99818, '99818', '99818', 3);
INSERT INTO `user` VALUES (123444, 'p2', '123444', 2);
INSERT INTO `user` VALUES (123455, '123455', '123455', 2);
INSERT INTO `user` VALUES (123456, 'Admin', 'Admin', 1);
...
CREATE TABLE `usulanbuku`  (
  `IdUsulan` int NOT NULL AUTO_INCREMENT,
  `Nis` int NOT NULL,
...
-- ----------------------------
-- Records of usulanbuku
-- ----------------------------
INSERT INTO `usulanbuku` VALUES (7, 99282, 'Judul', 'Penulis', 'Tidak Disebutkan', '2000', 1);
INSERT INTO `usulanbuku` VALUES (8, 99801, 'Merlian', 'Tidak Disebutkan', 'Tidak Disebutkan', '2005', 1);
INSERT INTO `usulanbuku` VALUES (9, 99801, 'Tidak Disebutkan', 'Diyah', 'Tidak Disebutkan', '', 1);
