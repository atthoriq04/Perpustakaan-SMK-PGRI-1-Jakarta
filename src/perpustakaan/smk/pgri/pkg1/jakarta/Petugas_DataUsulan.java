...
import static perpustakaan.smk.pgri.pkg1.jakarta.Petugas_DataJurusan.tmdl;

/**
 *
 * @author Atthoriq
 */
public class Petugas_DataUsulan extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Petugas_DataUsulan
     */
    public Petugas_DataUsulan() {
        initComponents();
    ...
    public void judul() {
            Object[] judul = {
         "Judul Buku", "Penerbit", "Penulis", "Tahun Terbit", "Nama Pengusul", "Nis"
        };
    ...
    public void Datas() {
        ...
        try {
            ...
            rst = stt.executeQuery("SELECT * FROM usulanbuku JOIN anggota ON usulanbuku.Nis = anggota.Nis WHERE Status = 1");
            while(rst.next()){
            Object[] data = {
                rst.getString("Judul"),
                rst.getString("Penerbit"),
                rst.getString("Penulis"),
                rst.getString("TahunTerbit"),
                rst.getString("Nama"),
                rst.getString("Nis")
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Data Usulan Buku");
        jPanel1.add(jLabel1);
        jLabel1.setBounds(110, 30, 350, 30);

        usul.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null},
                {null, null, null},
                {null, null, null},
        ...
        usul.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                usulMouseClicked(evt);
            }
        });
        usul.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                usulKeyPressed(evt);
            }
        });
        jScrollPane1.setViewportView(usul);
        ...
        jPanel1.add(jLabel3);
        jLabel3.setBounds(1180, 120, 70, 15);
    ...
    private void toLoginMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_toLoginMouseClicked
        ...
        try {
            ...
            Logger.getLogger(Petugas_DataUsulan.class.getName()).log(Level.SEVERE, null, ex);
        }
        obj.setVisible(true);
        this.dispose();
    ...
    private void usulMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_usulMouseClicked
        int opt = JOptionPane.showConfirmDialog(null, "Apakah Usulan ini sudah Dipenuhi?" , "Update", JOptionPane.YES_NO_OPTION);
        if(opt==0){
            int i = usul.getSelectedRow();
            TableModel model = usul.getModel() ;
            String Judul = model.getValueAt(i, 0).toString();
            String penerbit = model.getValueAt(i, 1).toString();
            String penulis = model.getValueAt(i, 2).toString();
            String nis = model.getValueAt(i, 5).toString();
            try{
                String sql = "UPDATE usulanbuku SET Status = '2' WHERE nis = '"+ nis +"' AND judul = '"+ Judul +"' AND Penerbit ='"+ penerbit +"' AND Penulis = '"+ penulis +"'";
                prst = CC.prepareStatement(sql);
                prst.execute();
    ...
    }//GEN-LAST:event_usulMouseClicked

    private void usulKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_usulKeyPressed

    }//GEN-LAST:event_usulKeyPressed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Petugas_DataUsulan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Petugas_DataUsulan().setVisible(true);
            }
        });
    }
    ...
    public javax.swing.JTable usul;
