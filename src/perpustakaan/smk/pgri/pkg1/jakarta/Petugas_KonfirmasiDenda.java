...
public class Petugas_KonfirmasiDenda extends javax.swing.JFrame {
     ...
     */
    public Petugas_KonfirmasiDenda() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Konfirmasi Pembayaran Denda");
        jPanel1.add(jLabel1);
    ...
    private void toLoginMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_toLoginMouseClicked
        ...
        try {
            ...
            Logger.getLogger(Petugas_KonfirmasiDenda.class.getName()).log(Level.SEVERE, null, ex);
        }
        obj.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Petugas_KonfirmasiDenda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Petugas_KonfirmasiDenda().setVisible(true);
            }
        });
    }
